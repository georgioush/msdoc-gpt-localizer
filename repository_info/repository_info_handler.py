from repository_info.open_publishing_config_handler import OpenPublishingConfigHandler
from repository_info.breadcrumb_handler import BreadcrumbHandler
from repository_info.toc_handler import TOCHandler
...
class RepositoryInfoHandler:
    def __init__(self, repo_path: str):
        ...
        self.breadcrumb_handler = BreadcrumbHandler(self.config_handler.breadcrumb_file_path)
