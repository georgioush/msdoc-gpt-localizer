...
class OpenPublishingConfigHandler:
    ...
    def get_docsets_paths(self):
        ...
        for docset in self.config["docsets_to_publish"]:
            path = os.path.join(self.file_path, docset["build_source_folder"])
